...
def generate_cv_pdf(cv_data: dict, profile: dict, output_path: str, job_title: str = "", company: str = ""):
    ...
    story.append(Paragraph(_safe(cv_data.get("title", profile["title"])), styles["CVTitle"]))
    ...
    if experience:
        ...
        for exp in experience:
            ...
            story.append(Paragraph(
                f"<b>{company_name}</b> — <i>{role_name}</i>",
                styles["CVCompany"]
            ))
    ...
    if education:
        ...
        for edu in education:
            ...
            story.append(Paragraph(
                f"<b>{degree}</b> — {institution} ({period})",
                styles["CVProject"]
            ))
...
def get_cv_filename(company: str, job_title: str) -> str:
    ...
    return f"CV_JoseGaspar_{company_part}_{title_part}_{timestamp}.pdf"
