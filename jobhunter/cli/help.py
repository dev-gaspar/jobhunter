...
def cmd_help():
    ...
    opts.add_row("--port N", "Puerto del dashboard [dim](dashboard, defecto 4090)[/dim]")
    opts.add_row("--days N", "Ventana de conciliacion [dim](sync, defecto 60)[/dim]")
    ...
    console.print("  [dim]$ jobhunter dashboard[/dim]")
    console.print("  [dim]$ jobhunter sync --days 90[/dim]")
    console.print()
